...
--SELECT insert_dummy_addresses(1000);
--SELECT insert_dummy_categories(100);

--SELECT insert_dummy_products(1000);
SELECT insert_dummy_orders(1000000);
SELECT insert_dummy_order_details(5000);
--SELECT insert_dummy_cart(100000);
--SELECT insert_dummy_cart_items(100000);
